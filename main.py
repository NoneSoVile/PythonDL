...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        train_sampler = None#torch.utils.data.SubsetRandomSampler(indices)#None
        val_sampler = None
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        val_acc1_list.append(val_acc1.item())
        val_acc5_list.append(val_acc5.item())        
        scheduler.step()
        ...
        with open('accuracy.csv', 'w', newline='') as csvfile:
            ...
            for epo in range(epoch + 1):
                writer.writerow({'epoch': epo + 1,
                                'train_acc1': train_acc1_list[epo],
                                'train_acc5': train_acc5_list[epo],
                                'val_acc1': val_acc1_list[epo],
                                'val_acc5': val_acc5_list[epo]})
